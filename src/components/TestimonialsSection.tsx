...
const TestimonialsSection = () => {
  const testimonials = [
    {
      id: 1,
      quote: "Ebonix has completely transformed how we approach our digital strategy. The features are intuitive and powerful.",
    ...
    {
      id: 2,
      quote: "The analytics capabilities alone have saved us countless hours and helped us make data-driven decisions with confidence.",
      author: "Michael Chen",
    ...
    {
      id: 3,
      quote: "Implementation was seamless and the customer support team has been incredibly responsive to our needs.",
  ...
  return (
    <section className="py-20 md:py-32 bg-ebonix-black relative overflow-hidden">
            ...
            >
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-ebonix-gray-light">{testimonial.role}, {testimonial.company}</p>
                </div>
              </div>
            </div>
          ))}
